...
my $t = Test::Nginx->new()->has(qw/http/)->plan(165);
...
like(http_get('/concatFile/??fuck.css,hello.css,world.css'), $concat_message46, 'concat - insert separator');
...
like(http_get('/concatFile/??fuck.css,hello.css,world.css'), $concat_message47, 'concat - insert separator');
