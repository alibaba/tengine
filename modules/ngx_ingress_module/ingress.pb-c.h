...
typedef struct _Ingress__UnitRedirect Ingress__UnitRedirect;
typedef struct _Ingress__UnitWeight Ingress__UnitWeight;
typedef struct _Ingress__Unit Ingress__Unit;
typedef struct _Ingress__Redirect Ingress__Redirect;
typedef struct _Ingress__FailoverRule Ingress__FailoverRule;
typedef struct _Ingress__Failover Ingress__Failover;
typedef struct _Ingress__VirtualService Ingress__VirtualService;
typedef struct _Ingress__ExpireTime Ingress__ExpireTime;
typedef struct _Ingress__HostCertEntry Ingress__HostCertEntry;
...
typedef enum _Ingress__HostType {
  /*
   * web
   */
  INGRESS__HOST_TYPE__Web = 0,
  /*
   * mtop
   */
  INGRESS__HOST_TYPE__MTOP = 1,
  /*
   * mcp
   */
  INGRESS__HOST_TYPE__MCP = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(INGRESS__HOST_TYPE)
} Ingress__HostType;
...
struct  _Ingress__UnitRedirect
{
  ProtobufCMessage base;
  char *from;
  char *to;
};
#define INGRESS__UNIT_REDIRECT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__unit_redirect__descriptor) \
    , NULL, NULL }


struct  _Ingress__UnitWeight
{
  ProtobufCMessage base;
  char *unit;
  protobuf_c_boolean has_weight;
  uint32_t weight;
  protobuf_c_boolean has_consistent_hashing;
  protobuf_c_boolean consistent_hashing;
};
#define INGRESS__UNIT_WEIGHT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__unit_weight__descriptor) \
    , NULL, 0, 0, 0, 0 }


struct  _Ingress__Unit
{
  ProtobufCMessage base;
  char *generic_unit;
  size_t n_redirects;
  Ingress__UnitRedirect **redirects;
  size_t n_weights;
  Ingress__UnitWeight **weights;
};
#define INGRESS__UNIT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__unit__descriptor) \
    , NULL, 0,NULL, 0,NULL }


struct  _Ingress__Redirect
{
  ProtobufCMessage base;
  char *host;
};
#define INGRESS__REDIRECT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__redirect__descriptor) \
    , NULL }


struct  _Ingress__FailoverRule
{
  ProtobufCMessage base;
  size_t n_err_codes;
  uint32_t *err_codes;
  ...
  Ingress__Redirect *redirects;
};
#define INGRESS__FAILOVER_RULE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__failover_rule__descriptor) \
    , 0,NULL, NULL, NULL, NULL }


struct  _Ingress__Failover
{
  ProtobufCMessage base;
  size_t n_rules;
  Ingress__FailoverRule **rules;
};
#define INGRESS__FAILOVER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__failover__descriptor) \
    , 0,NULL }
...
struct  _Ingress__VirtualService
{
  ...
  Ingress__Unit *unit;
  size_t n_failover;
  Ingress__Failover **failover;
};
#define INGRESS__VIRTUAL_SERVICE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__virtual_service__descriptor) \
    , NULL, 0,NULL, NULL, 0, 0, 0,NULL, 0,NULL, NULL, 0,NULL }


struct  _Ingress__ExpireTime
{
  ProtobufCMessage base;
  uint64_t seconds;
  uint32_t nanoseconds;
};
#define INGRESS__EXPIRE_TIME__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__expire_time__descriptor) \
    , 0, 0 }


struct  _Ingress__HostCertEntry
{
  ProtobufCMessage base;
  char *hostname;
  char *pem_data1;
...
#define INGRESS__HOST_CERT_ENTRY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&ingress__host_cert_entry__descriptor) \
    , NULL, NULL, NULL }
...
struct  _Ingress__Config
{
  ...
  size_t n_host_certs;
  Ingress__HostCertEntry **host_certs;
};
...
void   ingress__expire_time__free_unpacked
                     (Ingress__ExpireTime *message,
                      ProtobufCAllocator *allocator);
/* Ingress__HostCertEntry methods */
...
typedef void (*Ingress__Action_Closure)
                 (const Ingress__Action *message,
                  void *closure_data);
typedef void (*Ingress__UnitRedirect_Closure)
                 (const Ingress__UnitRedirect *message,
                  void *closure_data);
typedef void (*Ingress__UnitWeight_Closure)
                 (const Ingress__UnitWeight *message,
                  void *closure_data);
typedef void (*Ingress__Unit_Closure)
                 (const Ingress__Unit *message,
                  void *closure_data);
typedef void (*Ingress__Redirect_Closure)
                 (const Ingress__Redirect *message,
                  void *closure_data);
typedef void (*Ingress__FailoverRule_Closure)
                 (const Ingress__FailoverRule *message,
                  void *closure_data);
typedef void (*Ingress__Failover_Closure)
                 (const Ingress__Failover *message,
                  void *closure_data);
typedef void (*Ingress__VirtualService_Closure)
                 (const Ingress__VirtualService *message,
                  void *closure_data);
typedef void (*Ingress__ExpireTime_Closure)
                 (const Ingress__ExpireTime *message,
                  void *closure_data);
typedef void (*Ingress__HostCertEntry_Closure)
                 (const Ingress__HostCertEntry *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    ingress__host_type__descriptor;
...
extern const ProtobufCMessageDescriptor ingress__unit_redirect__descriptor;
extern const ProtobufCMessageDescriptor ingress__unit_weight__descriptor;
extern const ProtobufCMessageDescriptor ingress__unit__descriptor;
extern const ProtobufCMessageDescriptor ingress__redirect__descriptor;
extern const ProtobufCMessageDescriptor ingress__failover_rule__descriptor;
extern const ProtobufCMessageDescriptor ingress__failover__descriptor;
extern const ProtobufCMessageDescriptor ingress__virtual_service__descriptor;
extern const ProtobufCMessageDescriptor ingress__expire_time__descriptor;
extern const ProtobufCMessageDescriptor ingress__host_cert_entry__descriptor;
